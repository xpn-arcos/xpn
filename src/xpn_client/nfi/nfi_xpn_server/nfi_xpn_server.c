...
int nfi_xpn_server_closedir(struct nfi_server * serv, struct nfi_fhandle * fh)
{
    if (serv -> xpn_session_dir == 1) 
    {
        ...
        printf("[SERV_ID=%d] [NFI_XPN] [nfi_xpn_server_closedir] nfi_xpn_server_closedir(%d)\n", serv -> id, fh_aux -> dir);
        ...
        printf("[SERV_ID=%d] [NFI_XPN] [nfi_xpn_server_closedir] nfi_xpn_server_closedir(%d)=%d\n", serv -> id, fh_aux -> dir, status.ret);
