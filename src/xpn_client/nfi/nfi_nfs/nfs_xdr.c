...
bool_t
xdr_nfsdata(xdrs, objp)
	XDR *xdrs;
	nfsdata *objp;
{
	if (!xdr_bytes(xdrs, (char **)&objp->nfsdata_val, (u_long *)&objp->nfsdata_len, MAXDATA)) {
		return (FALSE);
	}
	return (TRUE);
}
