...
enum clnt_stat mountproc_null_1(argp,res,clnt)
	void *argp;
	void * res;
	CLIENT *clnt;
{
...
enum clnt_stat mountproc_dump_1(argp,res,clnt)
	void *argp;
	mountlist *res;
	CLIENT *clnt;
{
...
enum clnt_stat
mountproc_umntall_1(argp,res, clnt)
	void *argp;
	void * res;
	CLIENT *clnt;
{
...
enum clnt_stat
mountproc_export_1(argp, res, clnt)
	void *argp;
	exports *res;
	CLIENT *clnt;
{
...
enum clnt_stat
nfsproc_getattr_2(argp, res, clnt)
	void * argp;
	attrstat *res;
	CLIENT *clnt;
{
...
enum clnt_stat 
nfsproc_readlink_2(argp,res, clnt)
	void *argp;
	readlinkres *res;
	CLIENT *clnt;
{
...
enum clnt_stat 
nfsproc_writecache_2(argp,res, clnt)
	void *argp;
	void *res;
	CLIENT *clnt;
{
