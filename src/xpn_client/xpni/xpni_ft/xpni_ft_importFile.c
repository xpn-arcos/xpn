   ...
   /* ... Functions / Funciones ......................................... */
    ...
    while (readed == len_d)
    {
       ...
       offset_p = block_p * fmeta.block_size ;
       ...
       ret = MATH_MISC_XorN(buf_p, buf_a, len_a, fmeta.block_size);

       /* write '1' parity block */
       ret = xpni_lowfsi_pwrite(xpni_fit_get_XPN_MDATA_FD(fd), buf_p, offset_p, fmeta.block_size);
