   ...
   /* ... Functions / Funciones ......................................... */
      ...
      )
      {
        ...
        /* debugging */
            ...
            printf("[%s:%d] xpni_ft_swrite_r5o(%d,%p,%lu,%lu); \n",
        ...
        if (!strncmp(fmeta_fsTag,FS_TAG_RAID5OUTER,strlen(FS_TAG_RAID5OUTER)))
	{
		switch (fmeta_nerrors)
		{
			...
			default:
                             ret = (-1);
#if defined(XPNI_DEBUG)
                             printf("[%s:%d] xpni_ft_swrite_r5o(%d,%p,%lu,%lu): %d fail(s)\n",
        ...
        else 
	{
            ret = (-1);
#if defined(XPNI_DEBUG)
            printf("[%s:%d] xpni_ft_swrite_r5o(%d,%p,%lu,%lu): Unknow file system tag: '%s' (not %s or %s)\n",
                   __FILE__,__LINE__,fd,buffer,(unsigned long)offset,(unsigned long)size,
