...
{
  debug_info("[bypass] >> Before fdsdirtable_get....\n");
...
int fdsdirtable_put ( DIR * dir )
{
  ...
  debug_info("[bypass] >> Before fdsdirtable_put....\n");
  debug_info("[bypass]    1) dir  => %p\n", dir);
...
{
  debug_info("[bypass] >> Before fdsdirtable_remove....\n");
  debug_info("[bypass]    1) dir  => %p\n", dir);
...
DIR fdsdirtable_getfd ( DIR * dir )
{
  ...
  debug_info("[bypass] >> Before fdsdirtable_getfd....\n");
  debug_info("[bypass]    1) dir  => %p\n", dir);
...
{
  debug_info("[bypass] >> Before chdir...\n");
  debug_info("[bypass]    1) path %s\n", path);
...
{
  debug_info("[bypass] >> Before fcntl...\n");
  debug_info("[bypass]    1) fd %d\n", fd);
...
{ 
  debug_info("[bypass] >> Before fsync...\n");
  debug_info("[bypass] 1) fd %d\n", fd);
...
int MPI_Finalize (void)
{
  ...
  debug_info("[bypass] >> Before MPI_Finalize\n");
