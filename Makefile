...
am__DIST_COMMON = $(srcdir)/Makefile.in $(top_srcdir)/./config/compile \
	...
	./config/install-sh ./config/missing AUTHORS COPYING ChangeLog \
	INSTALL NEWS README
...
CDEFS = -D_REENTRANT -DPOSIX_THREADS -DHAVE_CONFIG_H -DLINUX -DXPNI_LOWFSI_XPN -D_GNU_SOURCE -D_FILE_OFFSET_BITS=64 -DENABLE_MXML -DENABLE_NFS3 -DENABLE_MYSERVER
CFLAGS = -fPIC -O0 -g -g3 -ggdb -ggdb3 -Wall -Wextra
CPP = gcc -E
CPPFLAGS = -D_REENTRANT -DPOSIX_THREADS -DHAVE_CONFIG_H -DLINUX -DXPNI_LOWFSI_XPN -D_GNU_SOURCE -D_FILE_OFFSET_BITS=64 -DENABLE_MXML -DENABLE_NFS3 -DENABLE_MYSERVER -I$(HOME)/mxml/usr/include -I$(top_srcdir)/include -I$(top_srcdir)/include/base -I$(top_srcdir)/include/xpn -I$(top_srcdir)/include/xpn/xpn_simple -I$(top_srcdir)/include/nfi -I$(top_srcdir)/include/nfi/nfi_local -I$(top_srcdir)/include/xpni/xpni_ft -I$(top_srcdir)/include/xpni/xpni_log -I$(top_srcdir)/include/nfi/nfi_nfs3 -I$(top_srcdir)/include/nfi/nfi_myServer  
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
ECHO_C = 
...
NFI_MYSERVER = nfi_myserver
NFI_MYSERVER_OBJECTS = $(NFI_MYSERVER_OBJECTS)
NFI_NFS = 
NFI_NFS3 = nfi_nfs3
...
OS = __LINUX__
PACKAGE = expand
PACKAGE_BUGREPORT = xpn@arcos.inf.uc3m.es
PACKAGE_NAME = Expand
