...
CDEFS = -D_REENTRANT -DPOSIX_THREADS -DHAVE_CONFIG_H -DLINUX -DXPNI_LOWFSI_XPN -D_GNU_SOURCE -D_FILE_OFFSET_BITS=64 -DENABLE_MXML -DENABLE_NFS3 -DENABLE_TCPSERVER -DENABLE_MPISERVER -DDBG_NFI
CFLAGS = -fPIC -O0 -g -g3 -ggdb -ggdb3 -Wall -Wextra -DDBG_NFI
CPP = gcc -E
