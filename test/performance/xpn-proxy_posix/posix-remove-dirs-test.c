...
// Remove a deep directory tree (e.g., /tmp/expand/P1/deep/level1/level2/.../levelN)
void test_remove_deep_nesting(int levels) {
    char path[1024];
    for (int i = levels; i >= 1; --i) {
        snprintf(path, sizeof(path), "/tmp/expand/P1/deep");
        for (int j = 1; j <= i; ++j) {
    ...
    int ret = rmdir("/tmp/expand/P1/deep");
    test_result("Remove base dir '/tmp/expand/P1/deep'", 1, ret);
}

// Remove a wide directory tree (e.g., /tmp/expand/P1/wide/dir1 ... /tmp/expand/P1/wide/dirN)
void test_remove_wide_fanout(int count) {
    ...
    // Remove the base directory
    int ret = rmdir("/tmp/expand/P1/wide");
    test_result("Remove base dir '/tmp/expand/P1/wide'", 1, ret);
}
...
void test_stress_remove_create(int count) {
    ...
    // Remove the base directory
    int ret = rmdir("/tmp/expand/P1/stress");
    test_result("Remove base dir '/tmp/expand/P1/stress'", 1, ret);
}
...
int main(void) {
    ...
    ret = rmdir("/tmp/expand/P1/test_root/sub1");
