...
void h5_write_header_info_(int* MyPE,
...
void h5_write_lrefine_(hid_t* file_identifier,
		       int lrefine[],
		       int* local_blocks,
		       int* total_blocks,
		       int* global_offset)
...
void h5_write_nodetype_(hid_t* file_identifier,
			int nodetype[],
			int* local_blocks,
			int* total_blocks,
			int* global_offset)
{
  ...
  /* create the dataset */
  dataset = H5Dcreate(*file_identifier, "node type", H5T_NATIVE_INT,
		      dataspace, H5P_DEFAULT);
...
void h5_write_gid_(hid_t* file_identifier,
		   int global_id[][NGID],
		   int* local_blocks,
		   int* total_blocks,
		   int* global_offset)
{
  ...
  /* create the dataset */
  dataset = H5Dcreate(*file_identifier, "gid", H5T_NATIVE_INT,
		      dataspace, H5P_DEFAULT);
...
void h5_write_coord_(hid_t* file_identifier,
		     int* maximum_blocks,
		     int* coordinates,
		     int* local_blocks,
		     int* total_blocks,
		     int* global_offset)
{
  ...
  /* create the dataset */
  dataset = H5Dcreate(*file_identifier, "coordinates", H5T_NATIVE_DOUBLE,
		      dataspace, H5P_DEFAULT);
...
void h5_write_size_(hid_t* file_identifier,
		    int* maximum_blocks,
		    int* size,
		    int* local_blocks,
		    int* total_blocks,
		    int* global_offset)
{
  ...
  /* create the dataset */
  dataset = H5Dcreate(*file_identifier, "block size", H5T_NATIVE_DOUBLE,
		      dataspace, H5P_DEFAULT);
...
void h5_write_bnd_box_(hid_t* file_identifier,
                       int* maximum_blocks,
                       int* bnd_box,
                       int* local_blocks,
                       int* total_blocks,
...
void h5_write_bnd_box_min_(hid_t* file_identifier,
			   int* maximum_blocks,
			   int* bnd_box,
			   int* local_blocks,
			   int* total_blocks,
...
void h5_write_bnd_box_max_(hid_t* file_identifier,
			   int* maximum_blocks,
			   int*  bnd_box,
			   int* local_blocks,
			   int* total_blocks,
...
void h5_write_unknowns_(hid_t* file_identifier,
			...
			int* nguard,          /* num of guardcells in pass */ 
			int* maximum_blocks,  /* maximum num of blocks */
			double* unknowns,     /* [mblk][NZB][NYB][NXB][nvar] */
