...
int main()
{
	...
	printf("Despues ..... init \n");
	fd1 = xpn_unlink("/xpn1/jj");
	printf("xpn_unlink jj = %d\n",fd1);
	fd1 = xpn_unlink("/xpn1/jj1");
	printf("xpn_unlink jj = %d\n",fd1);
	
	fd1 = xpn_creat("/xpn1/jj",00777);
	printf("xpn_creat jj = %d\n",fd1);
	
	fd2 = xpn_creat("/xpn1/jj",0777);
	printf("xpn_creat jj = %d\n",fd2);
	
	fd3 = xpn_creat("/xpn1/jj1",0777);
