...
#ifdef DBG_WORKERS 
  printf("[WORKERS]pthread_create: antes create_thread mpiServer_worker_run\n");
#endif 
	//usleep(100);
	ret = pthread_create(&th_worker, &tattr, (void *)(mpiServer_worker_run), (void *)&st_worker);
	
#ifdef DBG_WORKERS 
  printf("[WORKERS]pthread_create: desp. create_thread mpiServer_worker_run = %d\n", ret);
#endif 
	if(ret != 0){
...
#ifdef DBG_WORKERS 
  printf("[WORKERS]pthread_create: antes lock mpiServer_worker_run\n");
#endif 
	pthread_mutex_lock(&m_worker);
#ifdef DBG_WORKERS 
  printf("[WORKERS]pthread_create: desp. lock mpiServer_worker_run\n");
#endif 
	while(busy_worker == TRUE){
#ifdef DBG_WORKERS 
  printf("[WORKERS]pthread_create: antes wait mpiServer_worker_run\n");
#endif 
		pthread_cond_wait(&c_worker, &m_worker);
#ifdef DBG_WORKERS 
  printf("[WORKERS]pthread_create: desp. wait mpiServer_worker_run\n");
#endif 
	}

#ifdef DBG_WORKERS 
  printf("[WORKERS]pthread_create: busy_worker= TRUE mpiServer_worker_run\n");
#endif 
	busy_worker = TRUE;

#ifdef DBG_WORKERS 
  printf("[WORKERS]pthread_create: antes unlock mpiServer_worker_run\n");
#endif 
	pthread_mutex_unlock(&m_worker);
#ifdef DBG_WORKERS 
  printf("[WORKERS]pthread_create: desp. unlock mpiServer_worker_run\n");
#endif 
	// siguiente hijo
...
#ifdef DBG_WORKERS 
  printf("[WORKERS]begin mpiServer_worker_run(%s)\n", id);
#endif 

#ifdef DBG_WORKERS 
  printf("[WORKERS]client: mpiServer_worker_run(%s) antes lock\n", id);
#endif 
  pthread_mutex_lock(&m_worker);
#ifdef DBG_WORKERS 
  printf("[WORKERS]client: mpiServer_worker_run(%s) desp. lock\n", id);
#endif 
...
#ifdef DBG_WORKERS 
  printf("[WORKERS]client: mpiServer_worker_run(%s) busy_worker = FALSE\n", id);
#endif 
 
  busy_worker = FALSE;
#ifdef DBG_WORKERS 
  printf("[WORKERS]client: mpiServer_worker_run(%s) signal\n", id);
#endif 
  //pthread_cond_signal(&c_worker);
  pthread_cond_broadcast(&c_worker);
#ifdef DBG_WORKERS 
  printf("[WORKERS]client: mpiServer_worker_run(%s) antes unlock\n", id);
#endif 
  pthread_mutex_unlock(&m_worker);
#ifdef DBG_WORKERS 
  printf("[WORKERS]client: mpiServer_worker_run(%s) desp. unlock\n", id);
#endif 
...
#ifdef DBG_WORKERS 
  printf("[WORKERS]end mpiServer_worker_run (ID=%s): end\n", id);
#endif 
  pthread_exit(0);
}
